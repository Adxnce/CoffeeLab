# Generated by Django 5.2 on 2025-05-05 03:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Producto',
            fields=[
                ('SKU', models.IntegerField(primary_key=True, serialize=False, verbose_name='ID de Producto')),
                ...
                ('imagen', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nombre del archivo de imagen (en static/img/)')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='coffeelab.carrito')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='coffeelab.producto')),
            ],
        ),
    ]
